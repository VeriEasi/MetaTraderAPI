...
namespace MT5API
{
    ...
    public enum EnumTerminalInfoString
    {
    ...
    public enum EnumSymbolInfoString
    {
        SYMBOL_BASIS = 73,
    ...
    public enum EnumSymbolChartMode
    {
        SYMBOL_CHART_MODE_BID = 0,
        SYMBOL_CHART_MODE_LAST = 1
    }

    public enum EnumSymbolOrderGTCMode
    {
        SYMBOL_ORDERS_GTC = 0,
    ...
    public enum EnumSymbolCALCMode
    {
    ...
    public enum EnumSymbolTradeMode
    {
    ...
    public enum EnumSymbolTradeExecution
    {
    ...
    public enum EnumSymbolSWAPMode
    {
    ...
    public enum EnumSymbolOptionRight
    {
        SYMBOL_OPTION_RIGHT_CALL = 0,
        SYMBOL_OPTION_RIGHT_PUT = 1
    }

    public enum EnumSymbolOptionMode
    {
    ...
    public enum EnumAccountInfoInteger
    {
    ...
    public enum EnumAccountInfoDouble
    {
    ...
    public enum EnumAccountInfoString
    {
    ...
    public enum EnumAccountStopOutMode
    {
    ...
    public enum EnumAccountMarginMode
    {
    ...
    public enum EnumOrderPropertyInteger
    {
    ...
    public enum EnumOrderPropertyDouble
    {
    ...
    public enum EnumOrderPropertyString
    {
    ...
    public enum EnumOrderTypeFilling
    {
        ORDER_FILLING_FOK = 0,
        ORDER_FILLING_IOC = 1,
    ...
    public enum EnumPositionPropertyInteger
    {
    ...
    public enum EnumPositionPropertyDouble
    {
    ...
    public enum EnumPositionPropertyString
    {
    ...
    public enum EnumPositionReason
    {
    ...
    public enum EnumDealPropertyInteger
    {
    ...
    public enum EnumDealPropertyDouble
    {
    ...
    public enum EnumDealPropertyString
    {
    ...
    public enum EnumTradeRequestActions
    {
    ...
    public enum EnumTradeTransactionType
    {
    ...
    public enum EnumAppliedVolume
    {
        VOLUME_TICK = 0,    //Tick volume
        VOLUME_REAL = 1     //Trade volume
    }

    public enum EnumSTOPrice
    {
