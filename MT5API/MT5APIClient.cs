...
namespace MT5API
{
    public class MT5APIClient
    {
        ...
        private const string LogProfileName = "MT5APIClient";

        public delegate void QuoteHandler(object sender, string symbol, double bid, double ask);


        #region Private Fields
        private static readonly MTLog Log = LogConfigurator.GetLogger(typeof(MT5APIClient));
        ...
        /// </returns>
        public bool OrderCalcMargin(EnumOrderType action, string symbol, double volume, double price, out double margin)
        {
        ...
        /// </returns>
        public bool OrderCalcProfit(EnumOrderType action, string symbol, double volume, double priceOpen, double priceClose, out double profit)
        {
        ...
        public double PositionGetDouble(EnumPositionPropertyDouble propertyId)
        {
        ...
        ///</summary>
        ///<param name="propertyId">Identifier of a position property.</param>
        public long PositionGetInteger(EnumPositionPropertyInteger propertyId)
        {
            var commandParameters = new ArrayList { (int)propertyId };
        ...
        ///</summary>
        ///<param name="propertyId">Identifier of a position property.</param>
        public string PositionGetString(EnumPositionPropertyString propertyId)
        {
            var commandParameters = new ArrayList { (int)propertyId };
        ...
        public double OrderGetDouble(EnumOrderPropertyDouble propertyId)
        {
            var commandParameters = new ArrayList { (int)propertyId };
        ...
        ///</summary>
        ///<param name="propertyId"> Identifier of the order property.</param>
        public long OrderGetInteger(EnumOrderPropertyInteger propertyId)
        {
            var commandParameters = new ArrayList { (int)propertyId };
        ...
        ///</summary>
        ///<param name="propertyId"> Identifier of the order property.</param>
        public string OrderGetString(EnumOrderPropertyString propertyId)
        {
            var commandParameters = new ArrayList { (int)propertyId };
        ...
        ///<param name="propertyId">Identifier of the order property.</param>
        public double HistoryOrderGetDouble(ulong ticketNumber, EnumOrderPropertyDouble propertyId)
        {
        ...
        ///<param name="ticketNumber">Order ticket.</param>
        ///<param name="propertyId">Identifier of the order property.</param>
        public long HistoryOrderGetInteger(ulong ticketNumber, EnumOrderPropertyInteger propertyId)
        {
            var commandParameters = new ArrayList { ticketNumber, (int)propertyId };
        ...
        ///<param name="ticketNumber">Order ticket.</param>
        ///<param name="propertyId">Identifier of the order property.</param>
        public string HistoryOrderGetString(ulong ticketNumber, EnumOrderPropertyString propertyId)
        {
            var commandParameters = new ArrayList { ticketNumber, (int)propertyId };
        ...
        public double HistoryDealGetDouble(ulong ticketNumber, EnumDealPropertyDouble propertyId)
        {
            var commandParameters = new ArrayList { ticketNumber, (int)propertyId };
        ...
        ///<param name="ticketNumber">Deal ticket.</param>
        ///<param name="propertyId"> Identifier of a deal property.</param>
        public long HistoryDealGetInteger(ulong ticketNumber, EnumDealPropertyInteger propertyId)
        {
            var commandParameters = new ArrayList { ticketNumber, (int)propertyId };
        ...
        ///<param name="ticketNumber">Deal ticket.</param>
        ///<param name="propertyId"> Identifier of a deal property.</param>
        public string HistoryDealGetString(ulong ticketNumber, EnumDealPropertyString propertyId)
        {
            var commandParameters = new ArrayList { ticketNumber, (int)propertyId };
        ...
        public bool PositionOpen(string symbol, EnumOrderType orderType, double volume, double price, double sl, double tp, string comment = "")
        {
        ...
        /// <param name="result">output result</param>
        /// <returns>true - successful check of the basic structures, otherwise - false.</returns>
        public bool PositionOpen(string symbol, EnumOrderType orderType, double volume, double price, double sl, double tp, string comment, out MQLTradeResult result)
        {
        ...
        /// <param name="result">output result</param>
        /// <returns>true - successful check of the basic structures, otherwise - false.</returns>
        public bool PositionOpen(string symbol, EnumOrderType orderType, double volume, double price, double sl, double tp, out MQLTradeResult result)
        {
        ...
        public double AccountInfoDouble(EnumAccountInfoDouble propertyId)
        {
            var commandParameters = new ArrayList { (int)propertyId };
        ...
        ///</summary>
        ///<param name="propertyId">Identifier of the property.</param>
        public long AccountInfoInteger(EnumAccountInfoInteger propertyId)
        {
            var commandParameters = new ArrayList { (int)propertyId };
        ...
        ///</summary>
        ///<param name="propertyId">Identifier of the property.</param>
        public string AccountInfoString(EnumAccountInfoString propertyId)
        {
            var commandParameters = new ArrayList { (int)propertyId };
        ...
        ///<param name="symbolName">Symbol name.</param>
        ///<param name="timeframe"> Period.</param>
        public int Bars(string symbolName, EnumTimeframes timeframe)
        {
        ...
        public int Bars(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime)
        {
        ...
        public int CopyRates(string symbolName, EnumTimeframes timeframe, int startPos, int count, out MQLRates[] ratesArray)
        {
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="ratesArray">Array of MqlRates type.</param>
        public int CopyRates(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out MQLRates[] ratesArray)
        {
        ...
        ///<param name="ratesArray">Array of MqlRates type.</param>
        public int CopyRates(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out MQLRates[] ratesArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        public int CopyTime(string symbolName, EnumTimeframes timeframe, int startPos, int count, out DateTime[] timeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, startPos, count };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="timeArray">Array of DatetTme type.</param>
        public int CopyTime(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out DateTime[] timeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), count };
        ...
        ///<param name="stopTime">Bar time corresponding to the last element to copy.</param>
        ///<param name="timeArray">Array of DatetTme type.</param>
        public int CopyTime(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out DateTime[] timeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        public int CopyOpen(string symbolName, EnumTimeframes timeframe, int startPos, int count, out double[] openArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, startPos, count };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="openArray">Array of double type.</param>
        public int CopyOpen(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out double[] openArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), count };
        ...
        ///<param name="openArray">Array of double type.</param>
        public int CopyOpen(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out double[] openArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        public int CopyHigh(string symbolName, EnumTimeframes timeframe, int startPos, int count, out double[] highArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, startPos, count };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="highArray">Array of double type.</param>
        public int CopyHigh(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out double[] highArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), count };
        ...
        ///<param name="stopTime">The start time for the last element to copy.</param>
        ///<param name="highArray">Array of double type.</param>
        public int CopyHigh(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out double[] highArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        public int CopyLow(string symbolName, EnumTimeframes timeframe, int startPos, int count, out double[] lowArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, startPos, count };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="lowArray">Array of double type.</param>
        public int CopyLow(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out double[] lowArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), count };
        ...
        ///<param name="stopTime">The start time for the last element to copy.</param>
        ///<param name="lowArray">Array of double type.</param>
        public int CopyLow(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out double[] lowArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        public int CopyClose(string symbolName, EnumTimeframes timeframe, int startPos, int count, out double[] closeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, startPos, count };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="closeArray">Array of double type.</param>
        public int CopyClose(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out double[] closeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), count };
        ...
        ///<param name="stopTime">The start time for the last element to copy.</param>
        ///<param name="closeArray">Array of double type.</param>
        public int CopyClose(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out double[] closeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        public int CopyTickVolume(string symbolName, EnumTimeframes timeframe, int startPos, int count, out long[] volumeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, startPos, count };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="volumeArray">Array of long type.</param>
        public int CopyTickVolume(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out long[] volumeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), count };
        ...
        ///<param name="stopTime">The start time for the last element to copy.</param>
        ///<param name="volumeArray">Array of long type.</param>
        public int CopyTickVolume(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out long[] volumeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="volumeArray">Array of long type.</param>
        public int CopyRealVolume(string symbolName, EnumTimeframes timeframe, int startPos, int count, out long[] volumeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, startPos, count };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="volumeArray">Array of long type.</param>
        public int CopyRealVolume(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out long[] volumeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), count };
        ...
        ///<param name="stopTime">The start time for the last element to copy.</param>
        ///<param name="volumeArray">Array of long type.</param>
        public int CopyRealVolume(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out long[] volumeArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        public int CopySpread(string symbolName, EnumTimeframes timeframe, int startPos, int count, out int[] spreadArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, startPos, count };
        ...
        ///<param name="count">Data count to copy.</param>
        ///<param name="spreadArray">Array of long type.</param>
        public int CopySpread(string symbolName, EnumTimeframes timeframe, DateTime startTime, int count, out int[] spreadArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), count };
        ...
        ///<param name="stopTime">The start time for the last element to copy.</param>
        ///<param name="spreadArray">Array of long type.</param>
        public int CopySpread(string symbolName, EnumTimeframes timeframe, DateTime startTime, DateTime stopTime, out int[] spreadArray)
        {
            var commandParameters = new ArrayList { symbolName, (int)timeframe, MT5TimeConverter.ConvertToMTTime(startTime), MT5TimeConverter.ConvertToMTTime(stopTime) };
        ...
        public int IndicatorCreate(string symbol, EnumTimeframes period, EnumIndicator indicatorType, List<MQLParam> parameters = null)
        {
        ...
        ///<param name="symbolName">Symbol name.</param>
        ///<param name="propId">Identifier of a symbol property.</param>
        public long SymbolInfoInteger(string symbolName, EnumSymbolInfoInteger propId)
        {
            var commandParameters = new ArrayList { symbolName, (int)propId };
        ...
        ///<param name="symbolName">Symbol name.</param>
        ///<param name="propId">Identifier of a symbol property.</param>
        public string SymbolInfoString(string symbolName, EnumSymbolInfoString propId)
        {
            var commandParameters = new ArrayList { symbolName, (int)propId };
        ...
        public bool SymbolInfoString(string symbolName, EnumSymbolInfoString propId, out string value)
        {
        ...
        public bool SymbolInfoSessionQuote(string name, EnumDayOfWeek dayOfWeek, uint sessionIndex, out DateTime from, out DateTime to)
        {
        ...
        ///<param name="from">Session beginning time in seconds from 00 hours 00 minutes, in the returned value date should be ignored.</param>
        ///<param name="to">Session end time in seconds from 00 hours 00 minutes, in the returned value date should be ignored.</param>
        public bool SymbolInfoSessionTrade(string name, EnumDayOfWeek dayOfWeek, uint sessionIndex, out DateTime from, out DateTime to)
        {
            var commandParameters = new ArrayList { name, (int)dayOfWeek, sessionIndex };
        ...
        {
            var commandParameters = new ArrayList { chartId };
            return (EnumTimeframes)SendCommand<int>(MT5CommandType.ChartPeriod, commandParameters);
        }
        ...
        ///</returns>
        public bool ChartNavigate(long chartId, EnumChartPosition position, int shift = 0)
        {
        ...
        public bool ObjectCreate(long chartId, string name, EnumObject type, int nwin, DateTime time, double price, List<Tuple<DateTime, double>> listOfCoordinates = null)
        {
        ...
        public bool ObjectSetDouble(long chartId, string name, EnumObjectPropertyDouble propId, double propValue)
        ...
        ///<param name="propValue">The value of the property.</param>
        public bool ObjectSetInteger(long chartId, string name, EnumObjectPropertyInteger propId, long propValue)
        ...
        ///<param name="propValue">The value of the property.</param>
        public bool ObjectSetString(long chartId, string name, EnumObjectPropertyString propId, string propValue)
        ...
        ///<param name="name">Name of the object.</param>
        ///<param name="propId">ID of the object property. The value can be one of the values of the ENUM_OBJECT_PROPERTY_DOUBLE enumeration.</param>
        public double ObjectGetDouble(long chartId, string name, EnumObjectPropertyDouble propId)
        {
        ...
        ///<param name="name">Name of the object.</param>
        ///<param name="propId">ID of the object property. The value can be one of the values of the ENUM_OBJECT_PROPERTY_INTEGER enumeration.</param>
        public long ObjectGetInteger(long chartId, string name, EnumObjectPropertyInteger propId)
        {
            var commandParameters = new ArrayList { chartId, name, (int)propId };
        ...
        ///<param name="name">Name of the object.</param>
        ///<param name="propId">ID of the object property. The value can be one of the values of the ENUM_OBJECT_PROPERTY_STRING enumeration.</param>
        public string ObjectGetString(long chartId, string name, EnumObjectPropertyString propId)
        {
            var commandParameters = new ArrayList { chartId, name, (int)propId };
        ...
        public int iAC(string symbol, EnumTimeframes period)
        {
            var commandParameters = new ArrayList { symbol, (int)period };
        ...
        public int iAD(string symbol, EnumTimeframes period, EnumAppliedVolume appliedVolume)
        {
        ...
        public int iADX(string symbol, EnumTimeframes period, int adxPeriod)
        {
        ...
        ///<param name="period">The value of the period can be one of the ENUM_TIMEFRAMES enumeration values, 0 means the current timeframe.</param>
        ///<param name="adxPeriod">Period to calculate the index.</param>
        public int iADXWilder(string symbol, EnumTimeframes period, int adxPeriod)
        {
            var commandParameters = new ArrayList { symbol, (int)period, adxPeriod };
        ...
        public int iAlligator(string symbol, EnumTimeframes period, int jawPeriod, int jawShift, int teethPeriod, 
            int teethShift, int lipsPeriod, int lipsShift, EnumMAMethod maMethod, EnumAppliedPrice appliedPrice)
        {
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iAMA(string symbol, EnumTimeframes period, int amaPeriod, int fastMaPeriod, int slowMaPeriod, int amaShift, EnumAppliedPrice appliedPrice)
        {
        ...
        ///<param name="symbol">The symbol name of the security, the data of which should be used to calculate the indicator.</param>
        ///<param name="period">The value of the period can be one of the ENUM_TIMEFRAMES enumeration values, 0 means the current timeframe.</param>
        public int iAO(string symbol, EnumTimeframes period)
        {
            var commandParameters = new ArrayList { symbol, (int)period };
        ...
        public int iATR(string symbol, EnumTimeframes period, int maPeriod)
        {
        ...
        ///<param name="period">The value of the period can be one of the ENUM_TIMEFRAMES enumeration values, 0 means the current timeframe.</param>
        ///<param name="maPeriod">The value of the averaging period for the indicator calculation.</param>
        public int iBearsPower(string symbol, EnumTimeframes period, int maPeriod)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod };
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iBands(string symbol, EnumTimeframes period, int bandsPeriod, int bandsShift, double deviation, EnumAppliedPrice appliedPrice)
        {
        ...
        public int iBullsPower(string symbol, EnumTimeframes period, int maPeriod)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod };
        ...
        ///<param name="maPeriod">The averaging period for the indicator calculation.</param>
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iCCI(string symbol, EnumTimeframes period, int maPeriod, EnumAppliedPrice appliedPrice)
        {
        ...
        public int iChaikin(string symbol, EnumTimeframes period, int fastMaPeriod, int slowMaPeriod, EnumMAMethod maMethod, EnumAppliedVolume appliedVolume)
        {
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iDEMA(string symbol, EnumTimeframes period, int maPeriod, int maShift, EnumAppliedPrice appliedPrice)
        {
        ...
        ///<param name="period">The value of the period can be one of the ENUM_TIMEFRAMES enumeration values, 0 means the current timeframe.</param>
        ///<param name="maPeriod">Averaging period (bars count) for calculations.</param>
        public int iDeMarker(string symbol, EnumTimeframes period, int maPeriod)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod };
        ...
        public int iEnvelopes(string symbol, EnumTimeframes period, int maPeriod, int maShift, EnumMAMethod maMethod, EnumAppliedPrice appliedPrice, double deviation)
        {
        ...
        public int iForce(string symbol, EnumTimeframes period, int maPeriod, EnumMAMethod maMethod, EnumAppliedVolume appliedVolume)
        {
        ...
        ///<param name="symbol">The symbol name of the security, the data of which should be used to calculate the indicator.</param>
        ///<param name="period">The value of the period can be one of the ENUM_TIMEFRAMES enumeration values, 0 means the current timeframe.</param>
        public int iForce(string symbol, EnumTimeframes period)
        {
            var commandParameters = new ArrayList { symbol, (int)period };
            return SendCommand<int>(MT5CommandType.iForce, commandParameters);
        }
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iFrAMA(string symbol, EnumTimeframes period, int maPeriod, int maShift, EnumAppliedPrice appliedPrice)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod, maShift, (int)appliedPrice };
        ...
        ///<param name="maMethod">Smoothing type. Can be one of the values of ENUM_MA_METHOD.</param>
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iGator(string symbol, EnumTimeframes period, int jawPeriod, int jawShift, int teethPeriod, 
            int teethShift, int lipsPeriod, int lipsShift, EnumMAMethod maMethod, EnumAppliedPrice appliedPrice)
        {
            var commandParameters = new ArrayList { symbol, (int)period, jawPeriod, jawShift, teethPeriod, teethShift, lipsPeriod, lipsShift, (int)maMethod, (int)appliedPrice };
        ...
        public int iIchimoku(string symbol, EnumTimeframes period, int tenkanSen, int kijunSen, int senkouSpanB)
        {
        ...
        ///<param name="period">The value of the period can be one of the ENUM_TIMEFRAMES enumeration values, 0 means the current timeframe.</param>
        ///<param name="appliedVolume">The volume used. Can be one of the constants of ENUM_APPLIED_VOLUME.</param>
        public int iBWMFI(string symbol, EnumTimeframes period, EnumAppliedVolume appliedVolume)
        {
            var commandParameters = new ArrayList { symbol, (int)period, (int)appliedVolume };
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iMomentum(string symbol, EnumTimeframes period, int momPeriod, EnumAppliedPrice appliedPrice)
        {
        ...
        public int iMFI(string symbol, EnumTimeframes period, int maPeriod, EnumAppliedVolume appliedVolume)
        {
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iMA(string symbol, EnumTimeframes period, int maPeriod, int maShift, EnumMAMethod maMethod, EnumAppliedPrice appliedPrice)
        {
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iOsMA(string symbol, EnumTimeframes period, int fastEmaPeriod, int slowEmaPeriod, int signalPeriod, EnumAppliedPrice appliedPrice)
        {
        ...
        ///<param name="signalPeriod">Averaging period for signal line calculation.</param>
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iMACD(string symbol, EnumTimeframes period, int fastEmaPeriod, int slowEmaPeriod, int signalPeriod, EnumAppliedPrice appliedPrice)
        {
            var commandParameters = new ArrayList { symbol, (int)period, fastEmaPeriod, slowEmaPeriod, signalPeriod, (int)appliedPrice };
        ...
        ///<param name="period">The value of the period can be one of the ENUM_TIMEFRAMES enumeration values, 0 means the current timeframe.</param>
        ///<param name="appliedVolume">The volume used. Can be any of the ENUM_APPLIED_VOLUME values.</param>
        public int iOBV(string symbol, EnumTimeframes period, EnumAppliedVolume appliedVolume)
        {
            var commandParameters = new ArrayList { symbol, (int)period, (int)appliedVolume };
        ...
        public int iSAR(string symbol, EnumTimeframes period, double step, double maximum)
        {
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iRSI(string symbol, EnumTimeframes period, int maPeriod, EnumAppliedPrice appliedPrice)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod, (int)appliedPrice };
        ...
        public int iRVI(string symbol, EnumTimeframes period, int maPeriod)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod };
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iStdDev(string symbol, EnumTimeframes period, int maPeriod, int maShift, EnumMAMethod maMethod, EnumAppliedPrice appliedPrice)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod, maShift, (int)maMethod, (int)appliedPrice };
        ...
        public int iStochastic(string symbol, EnumTimeframes period, int Kperiod, int Dperiod, int slowing, EnumMAMethod maMethod, EnumSTOPrice priceField)
        {
        ...
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iTEMA(string symbol, EnumTimeframes period, int maPeriod, int maShift, EnumAppliedPrice appliedPrice)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod, maShift, (int)appliedPrice };
        ...
        ///<param name="maPeriod">Averaging period (bars count) for calculation.</param>
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iTriX(string symbol, EnumTimeframes period, int maPeriod, EnumAppliedPrice appliedPrice)
        {
            var commandParameters = new ArrayList { symbol, (int)period, maPeriod, (int)appliedPrice };
        ...
        public int iWPR(string symbol, EnumTimeframes period, int calcPeriod)
        {
        ...
        ///<param name="maShift">Shift of the indicator relative to the price chart.</param>
        ///<param name="appliedPrice">The price used. Can be any of the price constants ENUM_APPLIED_PRICE or a handle of another indicator.</param>
        public int iVIDyA(string symbol, EnumTimeframes period, int cmoPeriod, int emaPeriod, int maShift, EnumAppliedPrice appliedPrice)
        {
        ...
        ///<param name="period">The value of the period can be one of the ENUM_TIMEFRAMES enumeration values, 0 means the current timeframe.</param>
        ///<param name="appliedVolume">The volume used. Can be any of the ENUM_APPLIED_VOLUME values.</param>
        public int iVolumes(string symbol, EnumTimeframes period, EnumAppliedVolume appliedVolume)
        {
            var commandParameters = new ArrayList { symbol, (int)period, (int)appliedVolume };
        ...
        public int iCustom(string symbol, EnumTimeframes period, string name, double[] parameters)
        {
        ...
        ///<param name="name">The name of the custom indicator, with path relative to the root directory of indicators (MQL5/Indicators/). If an indicator is located in a subdirectory, for example, in MQL5/Indicators/Examples, its name must be specified like: "Examples\\indicator_name" (it is necessary to use a double slash instead of the single slash as a separator).</param>
        ///<param name="parameters">input-parameters of a custom indicator. If there is no parameters specified, then default values will be used.</param>
        public int iCustom(string symbol, EnumTimeframes period, string name, int[] parameters)
        {
            Log.Debug("iCustom: called.");
            var response = SendRequest<int>(new ICustomRequest
            {
        ...
        ///<param name="name">The name of the custom indicator, with path relative to the root directory of indicators (MQL5/Indicators/). If an indicator is located in a subdirectory, for example, in MQL5/Indicators/Examples, its name must be specified like: "Examples\\indicator_name" (it is necessary to use a double slash instead of the single slash as a separator).</param>
        ///<param name="parameters">input-parameters of a custom indicator. If there is no parameters specified, then default values will be used.</param>
        public int iCustom(string symbol, EnumTimeframes period, string name, string[] parameters)
        {
            Log.Debug("iCustom: called.");
            var response = SendRequest<int>(new ICustomRequest
            {
        ...
        ///<param name="name">The name of the custom indicator, with path relative to the root directory of indicators (MQL5/Indicators/). If an indicator is located in a subdirectory, for example, in MQL5/Indicators/Examples, its name must be specified like: "Examples\\indicator_name" (it is necessary to use a double slash instead of the single slash as a separator).</param>
        ///<param name="parameters">input-parameters of a custom indicator. If there is no parameters specified, then default values will be used.</param>
        public int iCustom(string symbol, EnumTimeframes period, string name, bool[] parameters)
        {
            Log.Debug("iCustom: called.");
            var response = SendRequest<int>(new ICustomRequest
            {
        ...
        private void Connect(MTClient client)
        {
            ...
            lock (_locker)
            {
                ...
                if (state == MT5ConnectionState.Connected)
                {
                    ...
                    _client.MtEventReceived += ClientMT5EventReceived;
        ...
        private void ClientMT5EventReceived(MTEvent e)
        {
        ...
        private void ClientQuoteUpdated(MTQuote quote)
        {
        ...
        private void ClientQuoteRemoved(MTQuote quote)
        {
            if (quote != null)
            {
        ...
        private void ClientQuoteAdded(MTQuote quote)
        {
            if (quote != null)
            {
